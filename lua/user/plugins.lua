...
return packer.startup(function(use)
  ...
  use({
    ...
    commit = "0afa28734c6fadf625117a03759cc605b07b43ba",
  ...
  use({ "Vonr/align.nvim", commit = "2004d263bb1b1ec28e55cf56c35944ec4ea23f8b" })
  ...
  use({ "RRethy/vim-illuminate", commit = "c82e6d04f27a41d7fdcad9be0bce5bb59fcb78e5" }) -- word context highlighting
  ...
  use({'nvim-telescope/telescope-fzf-native.nvim', commit = "ae9d95da9ff5669eb8e35f758fbf385b3e2fb7cf", run = 'make' })
